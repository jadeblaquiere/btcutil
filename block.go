...
// Tx returns a wrapped transaction (cttutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (cttutil.Tx) for all
...
// instead provides easy access to wrapped versions (cttutil.Tx) of them.
