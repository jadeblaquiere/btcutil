...
import (
	...
	"github.com/jadeblaquiere/cttutil/coinset"
...
func NewCoin(index int64, value cttutil.Amount, numConfs int64) coinset.Coin {
	h := fastsha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = cttutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = cttutil.NewTxFromBytes(testSimpleCoinTxBytes)
