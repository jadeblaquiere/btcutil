...
(http://godoc.org/github.com/jadeblaquiere/cttutil/bloom)
...
```bash
$ go get -u github.com/jadeblaquiere/cttutil/bloom
```

## Examples

* [NewFilter Example]
  (http://godoc.org/github.com/jadeblaquiere/cttutil/bloom#example-NewFilter)  
