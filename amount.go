...
// prefix is used, or "Mystiko" for the base unit.  For all unrecognized
// units, "1eN CTT" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountMystiko:
		return "Mystiko"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " CTT"
	}
}

// Amount represents the base bitcoin monetary unit (colloquially referred
// to as a `Mystiko').  A single Amount is equal to 1e-8 of a bitcoin.
type Amount int64
...
//
// NewAmount is for specifically for converting CTT to Mystiko.
// For creating a new Amount with an int64 value which denotes a quantity of Mystiko,
...
func NewAmount(f float64) (Amount, error) {
	...
	return round(f * MystikoPerBitcoin), nil
}
...
// ToCTT is the equivalent of calling ToUnit with AmountCTT.
func (a Amount) ToCTT() float64 {
...
// the units with SI notation, or "Mystiko" for the base unit.
